										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/patients/patient11.jpg')}}" alt="User Image"></a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/patients/patient12.jpg')}}" alt="User Image"></a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/patients/patient13.jpg')}}" alt="User Image"></a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/patients/patient14.jpg')}}" alt="User Image"></a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="{{asset('admin/assets/img/patients/patient15.jpg')}}" alt="User Image"></a>
