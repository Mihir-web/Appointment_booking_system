											...
											<tbody>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2">
																<img class="avatar-img" src="{{asset('admin/assets/img/specialities/specialities-02.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2">
																<img class="avatar-img" src="{{asset('admin/assets/img/specialities/specialities-03.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2">
																<img class="avatar-img" src="{{asset('admin/assets/img/specialities/specialities-04.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="profile.html" class="avatar avatar-sm me-2">
																<img class="avatar-img" src="{{asset('admin/assets/img/specialities/specialities-05.png')}}" alt="Speciality">
															</a>
